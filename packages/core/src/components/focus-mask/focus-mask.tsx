 ...
 * some portions Copyright 2018 Jamison Judge
 *
...
export interface IFocusMaskProps extends IProps {
    /**
     * Whether pressing <kbd>escape</kbd> when focused on the mask should close the mask
    ...
    /**
     * Whether clicking outside the mask should cancel the alert
     * If this prop is enabled, then either `onCancel` or `onClose` must also be defined.
     * @default false
     */
    ...
    /**
     * Whether the component has a visible backdrop
     * @default false
     */
    hasBackdrop?: boolean;
    ...
    /**
     * CSS styles to apply to the mask
     */
...
export class FocusMask extends AbstractPureComponent<IFocusMaskProps, {}> {
    public static defaultProps: IFocusMaskProps = {
        canEscapeKeyCancel: false,
        canOutsideClickCancel: false,
        isOpen: false,
    };

    public static displayName = "Blueprint3.FocusMask";
